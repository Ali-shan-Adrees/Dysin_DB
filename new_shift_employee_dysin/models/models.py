...
#
#
# class new_shift_employee(models.Model):
#     _name = 'new.shift.employee'
...
#                                help="Start and End time of working.\n"
#                                     "A specific value of 24:00 is interpreted as 23:59:59.999999.", compute='sum_total', store=True)
...
#
#     """This Function Move to State on HR Approval """
#
#     def action_hr_approval(self):
#         self.state = 'hr'
#
#     """This Function Move to State on COO Approval """
#
